...
public class SpeechRecognizerManager {
    public static final String LOG_TAG = "StringMatch";
    ...
    protected class SpeechRecognitionListener implements RecognitionListener
    {
        ...
        public void onResults(Bundle results)
        {
            ...
            if(results!=null && mListener!=null)
                ...
                // adding code to find particular word in speech- Ashwin kushwah

                ArrayList<String> check = results.getStringArrayList(SpeechRecognizer.RESULTS_RECOGNITION);

                //code to split the string
                String str = check.get(0);
                String[] arrOfStr = str.split(" ", 3);

                for (String a : arrOfStr) {
                    if (a.equals("hello")) {
                        Log.v(LOG_TAG, "confirm matched");
                        //flag = true;
