...
public class MultiBoxTracker {
  ...
  //changes made by arham ....drawtext ..imageLabel
  public synchronized void draw(final Canvas canvas) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      borderedText.drawText(canvas, trackedPos.left + cornerSize, trackedPos.bottom, "Image Label : " + Integer.toString(imgCnt++));
    }
  }
